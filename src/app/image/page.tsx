...
const imageTools = [
  { name: "Image Compressor", desc: "Reduce image file size", icon: "📉", href: "/image/compress" },
  { name: "Image Resizer", desc: "Change image dimensions", icon: "📐", href: "/image/resize" },
  { name: "Image Converter", desc: "Convert image formats", icon: "🔄", href: "/image/convert" },
];
    ...
    <div className="flex flex-col items-center pb-24 w-full">
      <header className="w-full text-center py-20 flex flex-col items-center border-b border-black/5 dark:border-white/5 mb-12">
        ...
        <p className="text-lg opacity-70 max-w-xl text-balance">
          Compress, resize, and convert your images instantly using high-performance browser technology.
        </p>
      </header>
